...
class lidar_nudt:
    def __init__(self):
        ...
        if self.enemy_is_blue:
            self.pos_data = [2300, 250, 1500, 850, 1500, 100, 1950, 1350, 1600, 1450, 2250, 750]
        else:
            # 敌方是红方
            self.pos_data = [500, 1250, 1300, 650, 1300, 1400, 850, 150, 1200, 500, 570, 750]
        # 定时器一直发送
    ...
    def timer_callback(self,event):
        if self.enemy_is_blue:
            ...
            #     self.pos_data[5] = 100
            # if (t1 - t0) <= 150:
            #     self.pos_data[6] = 1950
            #     self.pos_data[7] = 1350
            if (t1 - t0) <= 20:
                self.pos_data[8] = 1600
                self.pos_data[9] = 1450
