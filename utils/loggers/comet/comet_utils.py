...
def check_comet_weights(opt):
    """Downloads model weights_test from Comet and updates the
    weights_test path to point to saved weights_test location
    ...
    Returns:
        None/bool: Return True if weights_test are successfully downloaded
            else return None
    """
    if comet_ml is None:
        return
